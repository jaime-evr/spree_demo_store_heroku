...
#gem 'spree_mobile_endpoints', path: '../spree_mobile_endpoints'
gem 'spree_mobile_endpoints', git: 'https://github.com/ulices/spree_mobile_endpoints', branch: 'test/2-3-stable'
